  ...
  render() {
    return (
      <View style={{ height: getPixel(400) }}>
        ...
        <Swiper style={styles.wrapper} showsButtons={true} autoplay={false} loop={true} index={this.state.swiperIndex} onIndexChanged={(index: any)=>this.setState({swiperIndex: index})}>
